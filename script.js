document.getElementById("miFormulario").addEventListener("submit", async function(event) {
    ...
    if (isProhibitedEmail) {
        errorMessage.textContent = "Utiliza un correo gmail válido";
        errorMessage.style.color = 'red';
